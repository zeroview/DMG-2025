...
impl Palette {
    ...
    pub fn accurate_lcd() -> Self {
        Self(
            Color::new(0.327778, 0.5028864, 0.0047769),
            Color::new(0.2581828, 0.4125426, 0.0047769),
            Color::new(0.0295568, 0.1221387, 0.0295568),
            Color::new(0.0047769, 0.0395462, 0.0047769),
        )
    }

    pub fn lcd() -> Self {
        Self(
            Color::new(0.7454042, 0.9386857, 0.6307571),
            Color::new(0.2462013, 0.5271151, 0.1620293),
            Color::new(0.0343398, 0.1384316, 0.0930589),
            Color::new(0.0024282, 0.0091340, 0.0144438),
        )
    }
